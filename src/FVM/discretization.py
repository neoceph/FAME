    ...
    def discretizeHeatDiffusion(self, thermalConductivity):
        ...
        for cellID in range(numCells):
            ...
            for sharedCellID, sharedFace in zip (self.mesh.sharedCells[cellID]['shared_cells'], self.mesh.sharedCells[cellID]['shared_faces']):
                ...
                self.solver.A[cellID, cellID] += - self.property * (faceArea)/(cellDistance)
            ...
            for sharedBoundaryFace in self.mesh.sharedCells[cellID]['boundary_faces']:
                ...
                self.solver.A[cellID, cellID] += - self.property * (boundaryFaceArea)/(cell_to_boundary_face_distance) - self.boundaryCondition.convectionCoefficient
